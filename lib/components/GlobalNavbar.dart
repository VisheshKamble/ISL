  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.symmetric(
          horizontal: hMargin, vertical: isMobile ? 12 : 20),
      ...
      child: Row(
        ...
        children: [
          ...
          if (isMobile)
            _MobileActions(
              activeRoute: activeRoute, toggleTheme: toggleTheme,
              setLocale: setLocale, currentLocale: locale,
              isDark: isDark, primary: primary, l: l,
            )
          else
            _DesktopActions(
              activeRoute: activeRoute, toggleTheme: toggleTheme,
  ...
  Widget build(BuildContext ctx) {
    return Row(mainAxisSize: MainAxisSize.min, children: [
      _MobileIconBtn(
        ...
        bgColor: const Color(0xFF0891B2).withOpacity(
            activeRoute == 'bridge' ? 0.18 : 0.08),
        borderColor: const Color(0xFF0891B2).withOpacity(
            activeRoute == 'bridge' ? 0.55 : 0.20),
...
class _MobileIconBtn extends StatelessWidget {
  ...
  final VoidCallback onTap;
  const _MobileIconBtn({required this.icon, required this.color,
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<String>(
      ...
      child: Container(
          ...
          child: Center(child: Text(current['flag']!,
    ...
    return PopupMenuButton<String>(
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(width: 6),
          Text(current['label']!, style: _nt(11, FontWeight.w600, accent, ls: 0.3)),
          const SizedBox(width: 4),
