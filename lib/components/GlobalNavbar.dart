...
class _Brand extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: AppLocalizations.of(context).t('app_title_short'),
      button: true,
      child: GestureDetector(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context).t('app_name_short'),
              style: _label(
                18,
                textClr,
                w: FontWeight.w800,
...
class _DesktopActionsState extends State<_DesktopActions> {
  ...
  void _goHomeSection(BuildContext ctx, WebHomeSection section) {
  ...
  Widget build(BuildContext ctx) {
    ...
    if (kIsWeb) {
      return Row(
        ...
        children: [
          _NavLink(
            label: widget.l.t('nav_home').toUpperCase(),
            isDark: widget.isDark,
            accent: accent,
            isActive: widget.activeRoute == 'home',
            onTap: () => _goHomeSection(ctx, WebHomeSection.home),
          ),
          _NavLink(
            label: widget.l.t('features_label'),
            isDark: widget.isDark,
            accent: teal,
            onTap: () => _goHomeSection(ctx, WebHomeSection.features),
          ),
          _NavLink(
            label: widget.l.t('objectives_label'),
            isDark: widget.isDark,
            accent: accent,
    ...
    return Row(
      ...
      children: [
        ...
        _NavLink(
          label: widget.l.t('assistant_tab_label').toUpperCase(),
          isDark: widget.isDark,
          accent: widget.isDark ? _navInfoD : _navInfo,
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(1),
                    boxShadow: [
                      BoxShadow(color: red.withOpacity(0.4), blurRadius: 6),
                    ],
                  ),
                ),
              ],
...
class _MobileActions extends StatelessWidget {
  ...
  Widget build(BuildContext ctx) {
    ...
    return Row(
      ...
      children: [
        Semantics(
          label: l.t('bridge_screen_title'),
          button: true,
          child: _MobileNavIconBtn(
            icon: Icons.compare_arrows_rounded,
            color: teal,
            bgColor: teal.withOpacity(activeRoute == 'bridge' ? 0.15 : 0.08),
            borderColor: teal.withOpacity(
              activeRoute == 'bridge' ? 0.40 : 0.15,
            ),
            onTap: () {
...
class _ThemeToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Semantics(
    label: AppLocalizations.of(
      context,
    ).t(isDark ? 'common_switch_to_light_mode' : 'common_switch_to_dark_mode'),
    button: true,
    child: InkWell(
      ...
      builder: (_, _) => InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(8),
            border: Border.all(
              color: c.withOpacity(widget.isActive ? 0.55 : 0.28),
              width: 1,
            ),
            boxShadow: [
              BoxShadow(
          ...
          child: Center(
            child: Text(
              AppLocalizations.of(context).t('nav_emergency'),
              style: _label(
                9,
                c,
                w: FontWeight.w900,
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<String>(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(cur['flag']!, style: const TextStyle(fontSize: 16)),
        ),
      ),
    );
  }
