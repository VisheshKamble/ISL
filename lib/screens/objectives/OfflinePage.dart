      ...
      sections: [
        ...
        ObjSection(
          ...
          child: Column(children: [
            ...
            ObjTimelineItem(year: l.t('off_t4_year'), event: l.t('off_t4_event'), accent: accent, isDark: isDark),
            ObjTimelineItem(year: l.t('off_t5_year'), event: l.t('off_t5_event'), accent: accent, isDark: isDark, isLast: true),
          ]),
        ),
      ],
    );
