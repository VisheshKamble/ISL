...
class _AppleNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bg = isDark
        ? _dSurface.withValues(alpha: 0.94)
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Center(child: Text(title, style: _headline(textClr))),
            ),
            if (trailing != null)
              Padding(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(l.t('sos_add_first'), style: _headline(textClr)),
          const SizedBox(height: _sp6),
          Text(
            l.t('sos_add_first_body'),
            textAlign: TextAlign.center,
            style: _footnote(subClr),
          ),
        ],
                ...
                children: [
                  Row(
                    children: [
                      ...
                      _MicroChip(
                        label: _relationLabel(l, c.relation),
                        color: accent,
                        isDark: isDark,
                      ),
                    ],
...
class _TapTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    onTap: onTap,
    behavior: HitTestBehavior.opaque,
    child: Padding(padding: const EdgeInsets.all(_sp8), child: child),
  );
}
    ...
    final caps = isMobile
        ? [
            (
              ...
              l.t('sos_cap_mobile_1_title'),
              l.t('sos_cap_mobile_1_desc'),
            ),
            (
              _info,
              Icons.vibration_rounded,
              l.t('sos_cap_mobile_2_title'),
              l.t('sos_cap_mobile_2_desc'),
            ),
            (
              _success,
              Icons.location_on_rounded,
              l.t('sos_cap_mobile_3_title'),
              l.t('sos_cap_mobile_3_desc'),
            ),
            (
              _warning,
              Icons.notifications_rounded,
              l.t('sos_cap_mobile_4_title'),
              l.t('sos_cap_mobile_4_desc'),
            ),
          ]
        : [
            (
              ...
              l.t('sos_cap_web_1_title'),
              l.t('sos_cap_web_1_desc'),
            ),
            (
              _success,
              Icons.location_on_rounded,
              l.t('sos_cap_web_2_title'),
              l.t('sos_cap_web_2_desc'),
            ),
            (
              _warning,
              Icons.content_copy_rounded,
              l.t('sos_cap_web_3_title'),
              l.t('sos_cap_web_3_desc'),
            ),
            (
              _danger,
              Icons.link_rounded,
              l.t('sos_cap_web_4_title'),
              l.t('sos_cap_web_4_desc'),
            ),
          ];
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                isMobile ? Icons.phone_iphone_rounded : Icons.language_rounded,
                color: mutedClr,
                size: 12,
              ),
              const SizedBox(width: _sp6),
          ...
          const SizedBox(height: _sp16),
          Row(
            children: caps.asMap().entries.map((e) {
              final i = e.key;
              final cap = e.value;
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                      isEdit ? l.t('sos_edit_contact') : l.t('sos_new_contact'),
                      style: _headline(textClr),
                    ),
                    const Spacer(),
                    _TapTarget(
  ...
  void _save() async {
    ...
    widget.onSave(
      EmergencyContact(
        ...
        phone: _normalizePhoneInput(_phoneCtrl.text.trim()),
        relation: _relation,
