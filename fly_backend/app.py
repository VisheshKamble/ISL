...
cors_origin_regex = os.getenv(
    ...
    r"^(https?://(localhost|127\.0\.0\.1)(:\d+)?|https://.*\.up\.railway\.app|https://.*\.fly\.dev)$",
)
...
FILE_ID = os.getenv("MODEL_FILE_ID", "1TcCNyM1MtbixlN3wZgFttOlvuJutTPqB")
...
def initialize_model():
    ...
    if os.path.exists(MODEL_PATH) and os.path.getsize(MODEL_PATH) < MIN_MODEL_BYTES:
        log.info("Deleting corrupted model file (size too small)...")
